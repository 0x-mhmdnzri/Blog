...
public sealed class EnterpriseService : IEnterpriseService
{
    ...
    private readonly IAppBackupService _appBackup;
    ...
    public Task<BackupRecord> CreateBackupAsync(string actorId, CancellationToken ct = default) =>
        _appBackup.CreateFullBackupAsync(actorId, kind: "manual", ct);

    public Task<IReadOnlyList<BackupRecord>> ListBackupsAsync(CancellationToken ct = default) =>
        _appBackup.ListAsync(ct);

    public Task RestoreBackupAsync(int backupId, string actorId, CancellationToken ct = default) =>
        _appBackup.RestoreAsync(backupId, actorId, applySwap: false, ct);
