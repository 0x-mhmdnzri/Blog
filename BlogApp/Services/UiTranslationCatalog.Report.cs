...
public static partial class UiTranslationCatalog
{
    public static readonly (string Key, string Group, string Fa, string En, string Ar)[] Report =
    {
        ...
        ("report.details_label", "report", "توضیح", "Details", "التفاصيل"),
        ("report.details_placeholder", "report", "حداقل چند جمله بنویسید تا بررسی ممکن شود…", "Write a few sentences so we can review…", "اكتب جملاً قصيرة للمراجعة…"),
        ("report.details_hint", "report", "حداقل ۸ و حداکثر ۱۰۰۰ نویسه — الزامی", "Min 8, max 1000 characters — required", "٨–١٠٠٠ حرف — مطلوب"),
        ("report.details_required", "report", "توضیح الزامی است (حداقل ۸ نویسه).", "Details are required (min 8 characters).", "التفاصيل مطلوبة (٨ أحرف على الأقل)."),
