...
try
{
    ...
    builder.Services.AddSingleton<BotCrawlLogQueue>();
    builder.Services.AddHostedService<BotCrawlLogHostedService>();
    ...
    builder.Services.AddScoped<IAdminNavBadgeService, AdminNavBadgeService>();
    ...
    Log.Information("BlogApp monolith listening ForceHttps={ForceHttps}; P1.1 CanonicalUrl + P0.2 ServerTiming/OutputCache/BotCrawl registered",
        forceHttps);
    app.Run();
}
catch (Exception ex)
