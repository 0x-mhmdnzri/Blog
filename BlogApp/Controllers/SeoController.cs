...
public class SeoController : Controller
{
    ...
    public async Task<IActionResult> Robots()
    {
        ...
        // ── Default: public content welcome; private surfaces blocked ──
        ...
        // ── Major search crawlers: full public access, no crawl-delay ──
        ...
        // ── AI / archival crawlers: allow public content, same private blocks ──
        // Product tradeoff: allow citation/answer surfaces on posts & pages;
        // do not let them burn budget on admin, account, API, or parameter URLs.
        foreach (var bot in new[]
                 {
