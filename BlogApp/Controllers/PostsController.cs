...
public partial class PostsController : Controller
{
    ...
    public async Task<IActionResult> Details(string slug, string? sort = null)
    {
        ...
        var commentOpts = HttpContext.RequestServices
            .GetRequiredService<Microsoft.Extensions.Options.IOptions<CommentSpamOptions>>().Value;
        ViewBag.CommentEditWindowMinutes = commentOpts.EditWindowMinutes;
        ViewBag.CommentMaxBodyLength = commentOpts.MaxBodyLength;
